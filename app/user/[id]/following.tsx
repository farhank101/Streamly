/**
 * User Following Screen
 * Displays users that the specified user is following
 */
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>
          {profileUser.displayName} is Following
        </Text>
      ...
      {following.length > 0 ? (
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>
            When {profileUser.displayName} follows someone, they'll show up here
          </Text>
        </View>
      )}
    </View>
